...
This data comes from this [Kaggle competition](https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data) which provides details about homes in Ames, Iowa
...
The most important feature to my preferred model, the Ridge regression model, was the Overall Quality of the home (```OverallQual```), according to permutation importance:
